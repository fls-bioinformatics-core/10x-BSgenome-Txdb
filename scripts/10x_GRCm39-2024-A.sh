...
# Mouse GRCm39 (GENCODE v33/Ensembl 110)
#
# Exact build steps from https://www.10xgenomics.com/support/software/cell-ranger/downloads/cr-ref-build-steps
# `cellranger mkref` is commented out to stop the script from making the reference package
# * Both Cell Ranger and Cell Ranger ARC produces same modified fasta and filtered GTF
